...
public class VentanaCompraSilla extends JPanel {
	...
	private JRadioButton rbtnPreferencial;
        private JRadioButton rbtnDescuento;
	...
	public VentanaCompraSilla() {
		...
		lblCostoGeneral.setText("S/15.00");
		...
		lblCostoPreferencial.setText("S/10.00");
		...
		pnlComplementos.add(lblCostoPreferencial);
                ...
                JLabel lblObjetosDonados = new JLabel();
		lblObjetosDonados.setText("S/0.50");
		lblObjetosDonados.setBounds(0, 340, 100, 40);
		lblObjetosDonados.setFont((new Font("Comic Sans MS", 0, 11)));
		pnlComplementos.add(lblObjetosDonados);
		...
		pnlComplementos.add(rbtnPreferencial);
                ...
                rbtnDescuento = new JRadioButton();
		rbtnDescuento.setBounds(55, 340, 140, 40);
		rbtnDescuento.setText("Descuento");
		rbtnDescuento.setOpaque(false);
		rbtnDescuento.setFont((new Font("Comic Sans MS", 0, 13)));
		pnlComplementos.add(rbtnDescuento);
		...
		pnlComplementos.add(spnPreferencial);
                ...
                SpinnerModel smD = new SpinnerNumberModel(1, 1, 9, 1);
		spnDescuento = new JSpinner(smD);
		spnDescuento.setBounds(160, 340, 50, 30);
		spnDescuento.setFont((new Font("Comic Sans MS", 0, 11)));
		spnDescuento.setEditor(new JSpinner.DefaultEditor(spnDescuento));
		spnDescuento.setEnabled(false);
		pnlComplementos.add(spnDescuento);
        ...
        private int Multiplex(String multiplex){
            switch(multiplex){
                case "Cine: Plaza Norte":
                    return 0;
                case "Cine: Mega Plaza":
                    return 1;
                case "Cine: Centro Civico":
                    return 2;
                case "Cine: San Miguel":
                    return 3;
                case "Cine: Mall Sur":
                    return 4;
                case "Cine: Angamos":
	...
	public JRadioButton getRbtnPreferencial() {
        ...
        public JRadioButton getRbtnDescuento() {
		return rbtnDescuento;
	}
